		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Navigationandrouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Navigationandrouting-display": {
								"semanticObject": "Navigationandrouting",
								"action": "display",
								"description": "Navigation and routing application.",
								"title": "Navigation and routing",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navrout",
									"url": sap.ui.require.toUrl("navrout")
								}
							}
						}
					}
